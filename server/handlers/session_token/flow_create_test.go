...
func (f *fakeManager) CompleteFlowFailed(ctx context.Context, flowID string, failure *sessiontoken.FlowFailure) (*sessiontoken.Flow, error) {
	return nil, nil
}

func (f *fakeManager) MarkTokenInvalid(ctx context.Context, flowID string, code string, message string, api string) (*sessiontoken.Flow, error) {
	return nil, nil
}

func (f *fakeManager) FindFlowBySessionToken(ctx context.Context, token string) (*sessiontoken.Flow, error) {
	return nil, sessiontoken.ErrFlowNotFound
}
