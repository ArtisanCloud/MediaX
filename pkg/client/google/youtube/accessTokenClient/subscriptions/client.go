...
import (
	...
	"github.com/ArtisanCloud/MediaX/pkg/client/google/youtube/accessTokenClient/subscriptions/schema"
...
func (c *YoutubeSubscriptionsClient) List(ctx context.Context, data *schema.YouTubeSubscriptionsListReq) (*schema.YouTubeSubscriptionsListRes, error) {
	...
	_, err = c.BaseClient.HttpGet(ctx, "/youtube/v3/subscriptions", params, nil, result)
	return result, err
}
